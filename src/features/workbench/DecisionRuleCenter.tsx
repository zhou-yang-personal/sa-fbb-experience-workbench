...
const fields: Array<{ key: NumberKey; zh: string; en: string; unit: string }> = [
  ...
  { key: 'mesh_min_coverage_pct', zh: 'AP 证据最低覆盖率', en: 'Mesh evidence coverage', unit: '%' },
  { key: 'mesh_min_rtt_delta_ms', zh: '用户/网络 RTT 差门槛', en: 'User/network RTT delta', unit: 'ms' },
  { key: 'mesh_min_loss_delta_pct', zh: '用户/网络丢包差门槛', en: 'User/network loss delta', unit: 'pct' },
