...
INSERT IGNORE INTO meta_decision_rule_profile (
  ...
  3, 10, 30, 30.0, 20.0, 10.0, 20.0, 10.0,
  18, 23, 10.0, 20.0, 20.0, 80.0, 10,
  ...
  JSON_OBJECT(
    ...
    'heavy_usage_hours',10.0,
    'peak_hour_start',18,
    'peak_hour_end',23,
    'migration_min_traffic_gb',10.0,
    'speed_upgrade_min_traffic_gb',20.0,
    'speed_upgrade_max_effective_mbps',20.0,
    'mesh_min_wifi_delay_ms',80.0,
