...
- Selected P0: harden quality-report read-only guard for metadata commands
- Reason: keep the quality report bounded/read-only by rejecting schema metadata and diagnostic command drift before selecting lower-priority refactors
