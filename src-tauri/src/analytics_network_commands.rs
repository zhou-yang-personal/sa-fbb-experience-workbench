...
pub fn analytics_get_network_hotspots(req: DashboardRequest) -> Result<Vec<MetricCard>, String> {
    ...
    if let Ok(ads_table) = batch_tables::resolve_table(&req.settings, &req.import_batch_id, "ads_network_hotspot_rank") {
