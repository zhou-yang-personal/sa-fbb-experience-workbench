    ...
    conn.exec_map(
        ...
        |(user_key, user_type, days, gb, hours, vmos, mos, rtt, lead_type, demand, motive): (String, String, i64, f64, f64, f64, f64, f64, String, i64, i64)| MetricCard {
            ...
            MetricCard {
                label,
                value: format!("{gb:.2}"),
                hint: format!("user_key={user_key}, user_type={user_type}, active_days={days}, traffic_gb={gb:.2}, game_hours={hours:.2}, vmos={vmos:.2}, mos={mos:.2}, subscriber_rtt_ms={rtt:.2}, lead_type={lead_type}, demand_score={demand}, migration_motive_score={motive}, page_size={page_size}, offset={offset}"),
            }
        },
