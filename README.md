...
1.0.58 修复调查链路的历史 NULL 解码崩溃风险，并增加前端渲染故障隔离；1.0.56 的 hourly V2 分片、checkpoint、互斥锁和恢复日志能力保持不变。真实 Windows/MySQL 1320 万行的调查查询与完整恢复仍需在目标机器验收。
