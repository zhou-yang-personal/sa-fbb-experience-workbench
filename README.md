...
1.0.61 已压缩分析首屏，删除重复产品说明、技术上下文和空分析路径占位；1.0.60 的指标/App/用户全景、质差证据、Cable/FTTH 专项、四类潜客、版本化决策规则和子任务断点保持不变。真实 Windows/MySQL 1320 万行的 migration 011、聚合恢复和看板查询仍需在目标机器验收。
