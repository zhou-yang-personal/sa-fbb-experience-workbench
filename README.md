...
1.0.62 已修复执行日志抽屉的双标题、工具栏挤压、重复滚动和长文本布局问题；1.0.61 的紧凑分析首屏及 1.0.60 的全景、质差、接入和潜客能力保持不变。真实 Windows/MySQL 1320 万行的 migration 011、聚合恢复和看板查询仍需在目标机器验收。
