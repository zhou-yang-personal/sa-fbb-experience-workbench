...
- ResultTables 支持 SA Lead / Final Lead 前端筛选、分页和空状态。
- Final Lead 支持按 final_action 分组统计，并可点击 action 快速过滤。
- Final Lead Center 增加 SA Lead、Final Lead、Market Upsell、Reachability 导出路径预设。
- 新增通用 PaginationControls 和 ExportPresetActions 组件。
- 结果区样式补齐筛选工具栏、分页、表头和 action 统计标签。
