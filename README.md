...
1.0.57 修复了两处遗留任务接管确认项被通用输入框样式拉伸的问题；1.0.56 的 hourly V2 分片、checkpoint、互斥锁和恢复日志能力保持不变。真实 Windows/MySQL 1320 万行的分片耗时、索引构建耗时和完整恢复仍需在目标机器验收。
