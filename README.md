...
1.0.60 已将普通操作者主链路收敛为五个入口，并新增指标/App/用户全景、质差证据、Cable/FTTH 专项、四类潜客、版本化决策规则和子任务断点；1.0.56 的 hourly V2 分片、互斥锁和恢复日志继续保留。真实 Windows/MySQL 1320 万行的 migration 011、聚合恢复和看板查询仍需在目标机器验收。
